...
│   └── class-us-search-results-page.php # Search results page handler
│
├── templates/                      # Template files
│   └── search-results.php         # Custom search results page template
│
├── assets/                         # Static assets
│   ├── css/
│   │   ├── admin.css              # Admin panel styles
│   │   ├── frontend.css           # Frontend search form & results styles
│   │   └── search-page.css        # Search results page styles
│   │
│   ├── js/
