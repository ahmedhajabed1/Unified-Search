...
**Elementor:**
```
Add "Shortcode" widget â†’ Paste: [unified_search]
```

**Divi:**
```
Add "Code" module â†’ Content tab â†’ Paste: [unified_search]
```

**Gutenberg:**
```
Add "Shortcode" block â†’ Paste: [unified_search]
```
...
**Place in Appearance â†’ Customize â†’ Additional CSS**
